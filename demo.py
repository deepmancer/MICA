...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', default=None, type=str, help='Output directory (defaults to preprocessed_data/{video_name})')

    args = parser.parse_args()
    cfg = get_cfg_defaults()
    
    # Use provided output directory or default to env_paths
    if args.o is None:
        base_dir = f'{env_paths.PREPROCESSED_DATA}/{args.video_name}'
    else:
        base_dir = args.o
    
    args.i = f'{base_dir}/cropped/'
    args.o = f'{base_dir}/mica/'
    
    if os.path.exists(args.o):
        if len(os.listdir(args.o)) >= 10:
            print(f'''
